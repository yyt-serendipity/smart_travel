...
const tabMeta = {
  overview: {
    title: "后台工作台",
    description: "集中查看核心指标，并进入用户、内容和日志管理模块。",
  },
  users: {
    title: "用户信息管理",
    description: "管理账号状态、个人资料、头像和后台权限。",
  },
  cities: {
    title: "城市资产中心",
    description: "维护城市内容、封面、标签和推荐状态。",
  },
  attractions: {
    title: "景点资产中心",
    description: "集中管理景点图片、结构化资料和来源信息。",
  },
  posts: {
    title: "社区内容管理",
    description: "统一处理帖子内容、城市关联和社区沉淀资产。",
  },
  logs: {
    title: "系统操作日志",
    description: "审计导入、增删改和关键后台操作轨迹。",
  },
};
