<template>
  <article class="card community-feed-post community-feed-post-upgraded">
    ...
    <div class="community-feed-post-body">
      <div class="community-feed-post-body-head">
      ...
      <div class="community-feed-post-subline">
        <span v-if="state.attraction_name" class="pill">{{ state.attraction_name }}</span>
      </div>

      <RichTextContent
        class="community-feed-post-content"
        variant="compact"
        :html="state.content"
        :empty-text="state.content_preview"
        clamp
      />
