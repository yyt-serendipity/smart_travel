...
class TripPlan(models.Model):
    ...
    title = models.CharField("行程标题", max_length=160)
    traveler_name = models.CharField("出行人", max_length=100)
    departure_city = models.CharField("出发城市", max_length=100)
    destination_name = models.CharField("主目的地", max_length=100)
    start_date = models.DateField("出发日期", null=True, blank=True)
    duration_days = models.PositiveIntegerField("出行天数", default=5)
    travel_style = models.CharField("旅行风格", max_length=100)
    ...
    total_budget = models.PositiveIntegerField("预算估算", default=0)
    daily_outline = models.JSONField("日程概览", default=list, blank=True)
